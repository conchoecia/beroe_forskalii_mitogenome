...
rule plot_synteny:
    ...
    """
    input:
        twelveS =  "fasta_sequences/alignments/prot_cteno_aln/12S.fasta",
        sixteenS = "fasta_sequences/alignments/prot_cteno_aln/16S.fasta",
        COX1 =     "fasta_sequences/alignments/prot_cteno_aln/COX1.fasta",
        COX2 =     "fasta_sequences/alignments/prot_cteno_aln/COX2.fasta",
        COX3 =     "fasta_sequences/alignments/prot_cteno_aln/COX3.fasta",
        CYTB =     "fasta_sequences/alignments/prot_cteno_aln/CYTB.fasta",
        ND1 =      "fasta_sequences/alignments/prot_cteno_aln/ND1.fasta",
        ND2 =      "fasta_sequences/alignments/prot_cteno_aln/ND2.fasta",
        ND3 =      "fasta_sequences/alignments/prot_cteno_aln/ND3.fasta",
        ND4 =      "fasta_sequences/alignments/prot_cteno_aln/ND4.fasta",
        ND4L =     "fasta_sequences/alignments/prot_cteno_aln/ND4L.fasta",
        ND5 =      "fasta_sequences/alignments/prot_cteno_aln/ND5.fasta",
        ND6 =      "fasta_sequences/alignments/prot_cteno_aln/ND6.fasta",
